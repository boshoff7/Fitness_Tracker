...
class _GraphAreaState extends State<GraphArea>
  ...
  // Mock Data for steps graph
  List<DataPoint> data = [
    DataPoint(day: 1, steps: Random().nextInt(20000)),
    DataPoint(day: 2, steps: Random().nextInt(20000)),
    DataPoint(day: 3, steps: Random().nextInt(20000)),
    DataPoint(day: 4, steps: Random().nextInt(20000)),
    DataPoint(day: 5, steps: Random().nextInt(20000)),
    DataPoint(day: 6, steps: Random().nextInt(20000)),
    DataPoint(day: 7, steps: Random().nextInt(20000)),
    DataPoint(day: 8, steps: Random().nextInt(20000)),
  ];
      ...
      : _size = Tween<double>(begin: 0, end: 1).animate(
        ...
        _dotSize = Tween<double>(begin: 0, end: 1).animate(
          CurvedAnimation(
            parent: animation,
            curve:
                const Interval(0.30, 1, curve: Curves.easeInOutCubicEmphasized),
          ),
        ),
